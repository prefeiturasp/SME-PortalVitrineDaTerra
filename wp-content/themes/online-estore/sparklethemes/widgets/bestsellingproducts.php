...
class Online_Estore_Best_Selling_Products_Block extends WP_widget {
    ...
    public function __construct() {
        ...
        $widget_ops = array( 
            'classname' => 'online_estore_best_selling_products_block clearfix',
            'description' => esc_html__( 'Display a grid & slider view of your best products.', 'online-estore' )
        );

        parent::__construct( 'online_estore_Best_Selling_Products_Block', esc_html__( '&#9733; Best Selling Products', 'online-estore' ), $widget_ops );
    }
