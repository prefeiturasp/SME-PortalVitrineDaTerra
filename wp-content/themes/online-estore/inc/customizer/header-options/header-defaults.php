...
$header_defaults = array(
		...
		'desktop' => array(
			'top'    => array(
				array(
					...
					'width' => 6,
					'height' => 1,
					'id'	 => 'online_estore_header_quickinfo'
				),
				array(
					'x' 	=> 8,
					'y'		=> 1,
					'width' => 4,
					'height' => 3,
					'id'	 => 'online_estore_social_media_link'
				),
			...
			'main'   => array(
				...
				array(
					...
					'width'  => '6',
					'height' => '1',
					'id'     => 'online_estore_header_search',
				)
			),
			'bottom' => array(
				array(
	...
	'online_estore_main_header_bg_type'      => 'color-bg',
	'online_estore_main_header_bg_color' 	=> '#fff',
	...
	Icon fixed on get*/
	//search 
	'online_estore_search_type_options'      => 'advancesearch',
	'online_estore__search_icon_size'             => 18,
	
	'online_estore__search_icon_padding'           => json_encode(
		array(
			'desktop' => array(
				'top'         => '',
				'right'       => '',
	...
	'online_estore__search_icon_margin'           => json_encode(
		array(
			'desktop' => array(
				'top'         => '',
				'right'       => '',
	 ...
	 * Site Logo alignemnt
	 */
	'online_estore_title_tagline_alignment' => json_encode(
		array(
			'desktop' => 'left',
			'tablet'  => 'center',
			'mobile'  => 'center',
	...
	//search 
	'online_estore_search_type_options'      => 'advancesearch',
	'online_estore_search_icon_size'             => 18,
	
	'online_estore_search_icon_padding'           => json_encode(
		array(
			'desktop' => array(
				'top'         => '',
				'right'       => '',
	...
	'online_estore_search_icon_margin'           => json_encode(
		array(
			'desktop' => array(
				'top'         => '',
				'right'       => '',
	...
	/*button one*/
	'button-one-text'                           => esc_html__( 'Button One', 'online-estore' ),
	...
	/** home slider */
	'online_estore_slider_pause' => 5,
	'online_estore_slider_arrow' => 1,
	'online_estore_slider_loop' => 1,
	'online_estore_slider_dots' => 1,
	'online_estore_slider_loop' => 1,
	'online_estore_slider_auto_play' => 1,
	'online_estore_slider_mouse_drag' => 1,
