(function (api) {
    ...
    api.controlConstructor['range-slider'] = wp.customize.Control.extend({
        ready: function () {
            var control = this,
                    desktop_slider = control.container.find('.online-estore-slider.desktop-slider'),
                    desktop_slider_input = desktop_slider.next('.online-estore-slider-input').find('input.desktop-input'),
                    tablet_slider = control.container.find('.online-estore-slider.tablet-slider'),
                    tablet_slider_input = tablet_slider.next('.online-estore-slider-input').find('input.tablet-input'),
                    mobile_slider = control.container.find('.online-estore-slider.mobile-slider'),
                    mobile_slider_input = mobile_slider.next('.online-estore-slider-input').find('input.mobile-input'),
                    slider_input,
                    $this,
                    val;
            ...
            jQuery('input.desktop-input').on('change keyup paste', function () {
                $this = jQuery(this);
                val = $this.val();
                slider_input = $this.parent().prev('.online-estore-slider.desktop-slider');
            ...
            jQuery('input.tablet-input').on('change keyup paste', function () {
                $this = jQuery(this);
                val = $this.val();
                slider_input = $this.parent().prev('.online-estore-slider.tablet-slider');
            ...
            jQuery('input.mobile-input').on('change keyup paste', function () {
                $this = jQuery(this);
                val = $this.val();
                slider_input = $this.parent().prev('.online-estore-slider.mobile-slider');
