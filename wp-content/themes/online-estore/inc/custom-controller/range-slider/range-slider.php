...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'OnlineEstore_Range_Slider_Control' ) ) :
    /**
     * Slider Control
     */
    class OnlineEstore_Range_Slider_Control extends WP_Customize_Control {
        ...
        protected function content_template() {
            ...
            <div class="desktop control-wrap active">
                <div class="online-estore-slider desktop-slider"></div>
            ...
            <div class="tablet control-wrap">
                <div class="online-estore-slider tablet-slider"></div>
                <div class="online-estore-slider-input">
            ...
            <div class="mobile control-wrap">
                <div class="online-estore-slider mobile-slider"></div>
                <div class="online-estore-slider-input">
